...
class CharacterFilterViewController: UIViewController {
    ...
    private var filterButton = CustomButton(backgroundColor: UIColor(hex: 0x191970), title: "Filter")
    private var clearFilterButton = CustomButton(backgroundColor: UIColor(hex: 0x191970), title: "Clear")
    ...
    private func configureTextFields()  {
        ...
        genderTextField.textColor = .gray
    }
